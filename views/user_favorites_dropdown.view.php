...
<?php else: ?>
    <?php foreach ($userFavorites as $favorite): ?>
        <a class="dropdown-item mt-0 px-0.5" href="#">
            ...
            <?php if ($position): ?>
                <button class="dropdown-button" name="favorite-to-order" type="button" value="<?php echo $favorite["food_id"] ?>" style="position: relative" onclick="favoriteToOrderPosition(this.value);">
            ...
            <?php else: ?>
                <button class="dropdown-button" name="favorite-to-order" type="button" value="<?php echo $favorite["food_id"] ?>" onclick="favoriteToOrderPosition(this.value);">
