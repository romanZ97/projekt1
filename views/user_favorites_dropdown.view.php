    ...
    <?php foreach ($userFavorites as $favorite): ?>
        <a class="dropdown-item mt-0 px-0.5" href="#">
            <?php if ($dropdown_category != $favorite["category_id"]): ?>
                ...
                <div class="dropdown-header mt-2 mb-0 p-0"><link rel="icon" type="image/png" href="<?php echo $globalpath?>/assets/icons/<?php echo $favorite["category_icon"] ?>.png"><?php echo $favorite["category_name"] ?></div>
                <div class="dropdown-divider"></div>
            <?php endif; ?>

            <button class="uf-dropdown-button" type="submit" name="uf-favorite-delete"
                    value="<?php echo $favorite["dish_id"] ?>" style="margin-left: 5px; float: right">
            ...
            <button class="uf-dropdown-button" name="uf-favorite-to-order" value="<?php echo $favorite["dish_id"] ?>"
